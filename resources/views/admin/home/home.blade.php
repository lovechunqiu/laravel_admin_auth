...
<div id="top">
    <div class="fixed">
        <a href="{{url('admin')}}" title="" class="logo"><img src="{{asset("resources/views/admin/img/logo.png")}}" alt="" /></a>
        <ul class="top-menu">
            <li><a class="fullview"></a></li>
            <li id="refresh_wrapper"><a class="showmenu" title="刷新当前页"></a></li>
            <li class="dropdown">
                <a class="user-menu" data-toggle="dropdown"><span>{{session('admin_info.groupname')}} {{session('admin_info.adminname')}}<b class="caret"></b></span></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="{{url('admin/logout')}}" title=""><i class="icon-remove"></i>退出</a></li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div id="content">
        <div class="wrapper">
            ...
            <div class="crumbs">
                ...
                <div id="task-content">
                    <ul id="task-content-inner" class="breadcrumb">
                        <li app-id="0" app-name="首页" app-url="{{url('admin')}}" class="noclose"><a href="#" title=""><span>首页</span></a></li>
                    </ul>
                </div>
                <!--向右移动-->
            ...
            <div id="mycontent" style="height:700px;">
                <iframe src="{{url('admin/welcome')}}" style="width:100%;height:100%;" frameborder="0" id="appiframe-0" class="appiframe"></iframe>
            </div>
        </div>
    </div>
    <!-- /content -->
